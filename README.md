...
# Модель мультиагентной системы для решения задачи распределения вычислительных задач между ресурсами
...
Содержание:
- [Модель мультиагентной системы для решения задачи распределения вычислительных задач между ресурсами](#модель-мультиагентной-системы-для-решения-задачи-распределения-вычислительных-задач-между-ресурсами)
...
Иногда принятие оффера (или разрыв соглашения на обработку) может сместить другие задачи в расписании, при этом эти задачи будут уведомлены об изменениях.  
...
[Практика](https://github.com/Kiria-F/dart-mas-lab-assets/blob/main/%D0%9F%D0%BE%D1%81%D0%BE%D0%B1%D0%B8%D0%B5_%D0%BF%D0%BE_%D1%81%D0%BE%D0%B7%D0%B4%D0%B0%D0%BD%D0%B8%D1%8E_%D0%9C%D0%90%D0%A1_%D0%BD%D0%B0_Python_14.pdf) (Python)  


[def]: #модель-мультиагентной-системы-для-решения-задачи-распределения-вычислительных-задач-между-ресурсами